...
cpu0=$(get_config_value HPTCPUs0 ../config)
cpu1=$(get_config_value HPTCPUs1 ../config)
...
for rate in $(seq $starting_rate $increase $final_rate); do
	...
	remote_run_script $HPTMachine hpt/record_port.sh $exa_port0 /root/jcw78/nvme/hpt_accuracy_same_card/${rate}_joint_timing_0 $cpu0 /root/jcw78/nvme/hpt_accuracy_same_card/${rate}_joint_timing_0_cmd_out
	remote_run_script $HPTMachine hpt/record_port.sh $exa_port1 /root/jcw78/nvme/hpt_accuracy_same_card/${rate}_joint_timing_1 $cpu1 /root/jcw78/nvme/hpt_accuracy_same_card/${rate}_joint_timing_1_cmd_out
